...
def add_elo_rates(df_stat_flatten):
    ...
    #df_stat_flatten = pd.read_csv('../dataset/team_games_flatten.csv', dtype=data_type)
    nba_elo = pd.read_csv('../dataset/nba_elo.csv', dtype=data_type)
    #df_stat_flatten['GAME_DATE'] = df_stat_flatten['GAME_DATE'].astype(object)
    ...
    columns_to_drop = ['season', 'neutral', 'playoff', 'team2', 'elo1_post', 'elo2_post', 'score1', 'score2',
                       'is_home']  # Liste des noms des colonnes à supprimer
